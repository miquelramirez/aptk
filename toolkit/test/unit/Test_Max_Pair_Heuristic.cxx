#include "Test_Max_Pair_Heuristic.hxx"
#include <planning/heuristics/Max_Pair_Heuristic.hxx>

CPPUNIT_TEST_SUITE_REGISTRATION( Test_Max_Pair_Heuristic );

void Test_Max_Pair_Heuristic::setUp()
{
...
void Test_Max_Pair_Heuristic::tearDown()
{
	delete the_problem;
}

void Test_Max_Pair_Heuristic::test_correctness_1()
{

	aig_tk::Max_Pair_Heuristic	h;
	h.initialize( *the_problem );
	CPPUNIT_ASSERT_EQUAL( (unsigned)aig_tk::infty, h.eval( the_problem->init(), the_problem->goal() ) );
