#include "Test_Unsat_Goals_Heuristic.hxx"
#include <cppunit/TestAssert.h>
#include <planning/heuristics/Unsat_Goals_Heuristic.hxx>

CPPUNIT_TEST_SUITE_REGISTRATION( Test_Unsat_Goals_Heuristic );

void Test_Unsat_Goals_Heuristic::setUp()
{
...
void Test_Unsat_Goals_Heuristic::tearDown()
{
	delete the_problem;
} 

void Test_Unsat_Goals_Heuristic::test_correctness_1()
{
	aig_tk::Unsat_Goals_Heuristic h;
	h.initialize( *the_problem );
	CPPUNIT_ASSERT_EQUAL( h.eval( the_problem->init(), the_problem->goal() ), (unsigned) 1 );
}
