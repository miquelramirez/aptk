#include "Test_Additive_Heuristic.hxx"
#include <planning/heuristics/Additive_Heuristic.hxx>

CPPUNIT_TEST_SUITE_REGISTRATION( Test_Additive_Heuristic );

void Test_Additive_Heuristic::setUp()
{
...
void Test_Additive_Heuristic::tearDown()
{
	delete the_problem;
}

void Test_Additive_Heuristic::test_correctness_1()
{
	aig_tk::Additive_Heuristic	h;
